<template>
    <div class="second_level_page modify_pwd_page">
...
<script>
    ...
    import {changePassword} from 'src/service/getData'
    ...
    export default {
        ...
        methods: {
            ...
            async confirmButton(){
                ...
                let res = await changePassword(md5(this.oldPassword), md5(this.newPassword),this.userInfo.token);
                if (res.resultCode==0) {
                    this.showAlert = true;
